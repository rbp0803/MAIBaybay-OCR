...
function [output1,WBB,A,output,Baybayin_counter,message1,RW]=BaybayinxLatin_identifierP1(LvsB_classifier_00125,a)
% iniTime = clock;
...
text1=ocr(A,'Model',"English-fast",'Model',"tagalog",'LayoutAnalysis','Block');
