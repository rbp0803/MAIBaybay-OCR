...
function [output1,WBB,A,output,Baybayin_counter,message1,RW]=BaybayinOCR(a,OCRtype,LvsB_classifier_00125)

if OCRtype==2
 [output1,WBB,A,output,Baybayin_counter,message1,RW]=BaybayinxLatin_identifierP1(LvsB_classifier_00125,a);
 
elseif OCRtype==1 
 [output1,WBB,A,output,Baybayin_counter,message1,RW]=Baybayin_identifier_onlyP1(a);   
else
